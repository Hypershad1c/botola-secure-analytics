...
## SofaScore feasibility check

The supplied SofaScore page `https://www.sofascore.com/football/tournament/morocco/botola-pro/937#id:78750` was publicly reachable and exposed a Botola Pro 25/26 tournament page with public navigation for scores, news, results, fixtures, standings, and archive. SofaScore’s official [Sports data API availability FAQ](https://sofascore.helpscoutdocs.com/article/129-sports-data-api-availability), last updated 2025-11-06, states that SofaScore cannot share sports data sources in the form of API endpoints because of agreements with data providers, and directs media representatives to its widget partnership channel. Therefore this project will not reverse-engineer or bulk-extract undocumented SofaScore endpoints for database import. A licensed SofaScore/media partnership or another approved provider would be required. The public page may be linked from the application as an attribution/reference page, but it is not treated as an import source.
